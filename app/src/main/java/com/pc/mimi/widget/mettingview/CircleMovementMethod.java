...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod() {
        this.textViewBgColor = Utils.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = Utils.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
